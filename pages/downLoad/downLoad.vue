<template>
	<view class="tabs">
		...
		<swiper class="tab-box bgf" ref="swiper1" :current="tabIndex" :duration="300" @change="onswiperchange" @transition="onswiperscroll"
		...
		<view class="btns btns-active colorf  fon32 text-center margin-auto">
			下载
		</view>
	</view>
</template>
